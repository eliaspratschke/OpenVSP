...
MATRIX MATRIX::gauss_solve(MATRIX &vec, int max_iters, float toler)
{

    int i, j, neq, iter;
    float res, delta, max_res;
    MATRIX x(this->row);
...
#                                                                              #
#                             MATRIX diagonal                                  #
#         makes adiagonal matrix with val on the diagonals.
##############################################################################*/
